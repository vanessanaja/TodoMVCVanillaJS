...
This repository is one part of an assignment from Watch and Code by Gordon Zhu.

We were asked to remove jQuery from the todomvc app and rewrite it in Vanilla Javascript. The purpose was to practice writing and understanging Vanilla Javascript and figuring out how to recreate jQuery methods with VanillaJS either using what we already know or using online resources to figure out how to get it to work correctly.

If you'd like to see the original file with jQuery, you'll find it in the TodoMVCWithjQuery folder.

Below is the original README from Gordon Zhu about this project:
